  ...
  return (
    <section className="relative w-full h-screen md:h-[600px] overflow-hidden">
      ...
      <img
        ...
        className="absolute inset-0 w-full h-full object-cover opacity-50 hover:opacity-75 transition duration-300 z-0"
      />
        ...
        <div className="container mx-auto flex justify-end items-center">
          <div className="bg-[#2a2a2a] text-white max-w-lg p-12 md:p-10 shadow-lg">
            ...
            <p className="text-sm text-gray-300 mb-6 leading-relaxed ">
              ...
              later, Cahaya Desain Indonesia was established in 2015 with its
              sole purpose to deliver best value by adding professionalism to
              passion.
            </p>
            <Link
              href="/about"
