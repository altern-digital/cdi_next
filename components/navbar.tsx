    ...
    <nav className="bg-[#1e1e1e] text-white">
      <div className="container mx-auto px-4 py-4 flex justify-between items-center">
        ...
        <ul className="hidden md:flex space-x-6 text-sm font-semibold relative">
          <li>
            <Link
              href="/"
              className="inline-block border-b-[3px] border-transparent hover:border-blue-300 transition"
            >
              HOME
            </Link>
          </li>
          ...
          <li className="relative group">
            <button className="border-b-[3px] border-transparent hover:border-blue-300 flex items-center gap-2 transition">
      ...
      {isMobileMenuOpen && (
        <div className="md:hidden px-4 pb-4 space-y-2 text-sm font-semibold">
          <Link
            href="/"
            className="block hover:border-b-[3px] border-transparent hover:border-blue-300 pb-1"
          >
            HOME
          </Link>
          <Link
